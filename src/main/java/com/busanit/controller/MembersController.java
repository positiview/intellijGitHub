...
public class MembersController {
    ...
    // ~!@수정
    @PostMapping("/modify")
    public String modify(String password, @AuthenticationPrincipal MemberSecurityDTO memberSecurityDTO){

        customOAuth2UserDetailsService.updatePassword(passwordEncoder.encode(password),memberSecurityDTO.getEmail());
